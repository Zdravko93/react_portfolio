...
function App() {
  ...
  // if the user does eventually trigger a toast(), the component
  // is likely already loaded
  useEffect(() => {
  ...
  return (
    <main className="min-h-screen transition-colors duration-300 bg-[radial-gradient(circle_at_center,_#ffffff,_#f0f0f0)] dark:bg-[radial-gradient(circle_at_center,_#1a1a1a,_#000000)]">
      <Header
        // clickedSection vs activeSection
        // clickedSection refers is a user selected
        // navigation item (link)
        // if not selected, fallback to the user-scrolled position/section
