// ICONS
// STATS GRID + LEVEL COMPLETE SECTION
...
export const skillsInProgressData: string[] = ["Next.js", "TypeScript", "GSAP"];

export const levelCompleteData: LevelCompleteItemData[] = [
  {
    entry: "XP GAINED",
    value: "+300",
    percent: 75,
