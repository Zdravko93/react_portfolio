...
import type { ProjectImagesProps } from "../../types/userInterface";

const ProjectImages: React.FC<ProjectImagesProps> = React.memo(
  function ProjectImages({ images, setLightboxOpen }) {
