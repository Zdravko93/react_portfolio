...
import type { ProjectDetailsProps } from "../../types/userInterface";

const ProjectDetails: React.FC<ProjectDetailsProps> = React.memo(
  function ProjectDetails({ project, setLightboxOpen }) {
