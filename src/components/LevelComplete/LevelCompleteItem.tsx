...
import { LevelCompleteItemData } from "../../types/dataTypes";

const LevelCompleteItem: React.FC<LevelCompleteItemData> = React.memo(
  function LevelCompleteItem({
    entry,
    value,
    percent,
    image,
    ...
    const expProgressBarVariants: MotionProps = useMotionProps({
      variants: undefined,
      initial: { width: 0 },
      whileInView: { width: `${percent ?? 0}%` },
